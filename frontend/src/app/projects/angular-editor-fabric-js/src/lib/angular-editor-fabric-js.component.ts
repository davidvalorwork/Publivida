...
export class FabricjsEditorComponent implements AfterViewInit {
  ...
  setCanvasImage() {
    ...
    // this.clear()
    if (this.props.canvasImage) {
      this.canvas.setBackgroundColor(new fabric.Pattern({ source: this.props.canvasImage, repeat: 'no-repeat' }), () => {
        console.log("PRUEBA")
        console.log(this.props.canvasImage)
        self.props.canvasFill = '';
        this.imgBackground = this.props.canvasImage
  ...
  setCanvasImageInner() {
    const self = this;
    if (this.props.canvasImage) {
      this.canvas.setBackgroundColor(new fabric.Pattern({ source: this.imgBackground, repeat: 'no-repeat' }), () => {
        console.log("PRUEBA")
        console.log(this.imgBackground)
        self.props.canvasFill = '';
        setTimeout(function(){ self.canvas.renderAll(); }, 100)
        setTimeout(function(){ self.canvas.renderAll(); }, 200)
        setTimeout(function(){ self.canvas.renderAll(); }, 300)
        setTimeout(function(){ self.canvas.renderAll(); }, 400)
        setTimeout(function(){ self.canvas.renderAll(); }, 500);
      });
    }
  }
