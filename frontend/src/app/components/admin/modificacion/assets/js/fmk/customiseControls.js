...
(function(window) {
    ...
    fabric.util.object.extend(fabric.Canvas.prototype, {
        ...
        setCustomCursor: function(corner, cursorUrl) {
			...
			if(corner == 't') this['cursorMap'][0] = cursorUrl;
			if(corner == 'tr') this['cursorMap'][1] = cursorUrl;
			if(corner == 'r') this['cursorMap'][2] = cursorUrl;
			if(corner == 'br') this['cursorMap'][3] = cursorUrl;
			if(corner == 'b') this['cursorMap'][4] = cursorUrl;
			if(corner == 'bl') this['cursorMap'][5] = cursorUrl;
			if(corner == 'l') this['cursorMap'][6] = cursorUrl;
			if(corner == 'tl') this['cursorMap'][7] = cursorUrl;
